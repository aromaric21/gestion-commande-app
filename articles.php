...
?>
    ...
    <a href="addarticle.php" class="btn btn-primary" style="width:40px; float:right; margin-bottom:20px;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <button type="button" class="btn btn-danger" data-bs-toggle="modal"  <?php if(in_array($ligne["idarticle"],$list)){echo "disabled";}?>
